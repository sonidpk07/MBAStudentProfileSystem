...
<h2 class="title" align="center">Add a new Student</h2><hr><br>
	<c:if test="${!empty msg }">
...
<form:form action="addStudentAct" modelAttribute="addStuObj">
  ...
  <div class="form-group">
    ...
    class="form-control"  placeholder="700#" style="width:60%;" id="700#"/>
  </div>
  ...
  <button type="submit" class="btn btn-success">Add Student</button><br><br>
