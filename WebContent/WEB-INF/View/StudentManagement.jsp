...
<div class="col-lg-12">
<br>
<a href="addStudentPage" class="navbar-btn btn btn-success text-center">Add new Student</a><br>
<a href="showAllStudentPage" class="navbar-btn btn btn-primary text-center">Show All Student</a> <br>
<a href="nonAcademicList" class="navbar-btn btn btn-danger text-center">Student Not Completed ACC</a> 
<hr>
</div>
</div>
</div>
